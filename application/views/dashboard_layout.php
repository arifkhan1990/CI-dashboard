...
<head>
	...
	<!-- Morris chart -->
	<link rel="stylesheet" href="frontend/plugins/morris/morris.css">
	<!-- jvectormap -->
	<link rel="stylesheet" href="frontend/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
	<!-- Date Picker -->
	<link rel="stylesheet" href="frontend/plugins/datepicker/datepicker3.css">
	<!-- Daterange picker -->
	<link rel="stylesheet" href="frontend/plugins/daterangepicker/daterangepicker-bs3.css">
...
<div class="wrapper">
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		<!-- Brand Logo -->
		<a href="<?php echo base_url()?>user-login" class="brand-link">
							...
							<div class="card-body">
								...
								<div class="direct-chat-contacts">
									<ul class="contacts-list">
										<li>
											<a href="#">
												<img class="contacts-list-img" src="frontend/dist/img/user1-128x128.jpg">
										...
										<li>
											<a href="#">
												<img class="contacts-list-img" src="frontend/dist/img/user7-128x128.jpg">
										...
										<li>
											<a href="#">
												<img class="contacts-list-img" src="frontend/dist/img/user3-128x128.jpg">
										...
										<li>
											<a href="#">
												<img class="contacts-list-img" src="frontend/dist/img/user5-128x128.jpg">
										...
										<li>
											<a href="#">
												<img class="contacts-list-img" src="frontend/dist/img/user6-128x128.jpg">
										...
										<li>
											<a href="#">
												<img class="contacts-list-img" src="frontend/dist/img/user8-128x128.jpg">
...
<!-- Sparkline -->
<script src="frontend/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="frontend/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="frontend/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="frontend/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
...
<!-- FastClick -->
<script src="frontend/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
